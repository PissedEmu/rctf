...
export default withStyles({
  ...
  const handleRegister = useCallback(async () => {
    ...
    setErrors(errors)
  }, [discordToken, name, division, requestRecaptchaCode])
  ...
  // Try login with Discord token only, if fails prompt for name
